  ...
  <WithBanner>
    <div class="flex flex-col w-full lg:max-w-7xl mx-auto mb-16">
      <div class="text-center mx-auto mt-16">
        <h1
          class="text-4xl font-bold tracking-tight text-gray-500 sm:text-5xl md:text-6xl"
        >
          The
      ...
      <div
        class="sm:text-center lg:text-left mx-4 lg:mr-auto mt-16 lg:ml-16 lg:w-1/2"
      >
        <h1
      ...
      <div
        class="sm:text-center lg:text-right mx-4 lg:ml-auto mt-16 lg:mr-16 lg:w-1/2"
      >
        <h1
          class="text-4xl font-bold tracking-tight text-primary sm:text-5xl md:text-6xl"
        >
