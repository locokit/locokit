<template>
  <WithBanner>
    <div class="max-w-4xl xl:max-w-6xl mx-auto mt-8 pb-4 px-4 lg:px-0">
      ...
      <p class="mt-4 ">{{ $t('pages.workspace.intro') }}
      </p>
      ...
      <div class="mt-12">
        <div
          v-if="workspacesStore.workspaces && workspacesStore.workspaces.length > 0"
          class="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-4 mt-8 flex-wrap shrink-0">
          <div v-for="workspace in workspacesStore.workspaces" :key="workspace"
