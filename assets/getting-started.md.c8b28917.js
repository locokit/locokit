import{_ as n,c as s,o as a,d as t}from"./app.ee1354cf.js";const h='{"title":"Getting started","description":"","frontmatter":{},"headers":[{"level":2,"title":"docker-compose installation","slug":"docker-compose-installation"},{"level":2,"title":"cloning the repository (for dev)","slug":"cloning-the-repository-for-dev"}],"relativePath":"getting-started.md","lastUpdated":1650442056847}',e={},o=t(`<h1 id="getting-started" tabindex="-1">Getting started <a class="header-anchor" href="#getting-started" aria-hidden="true">#</a></h1><p>To start LocoKit, you can use the docker-compose installation or by cloning the repository.</p><h2 id="docker-compose-installation" tabindex="-1">docker-compose installation <a class="header-anchor" href="#docker-compose-installation" aria-hidden="true">#</a></h2><p>On your host, you&#39;ll have to create a <code>docker-compose.yml</code> file.</p><p>You can download it from <a href="https://raw.githubusercontent.com/locokit/locokit/master/docker-compose-starter.yml" target="_blank" rel="noopener noreferrer">https://raw.githubusercontent.com/locokit/locokit/master/docker-compose-starter.yml</a> directly if you want.</p><div class="language-yaml"><pre><code><span class="token comment"># This docker-compose is for testing purpose only</span>
