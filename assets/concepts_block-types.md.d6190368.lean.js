import{_ as n,c as s,o as a,d as t}from"./app.bb6a31ba.js";const _='{"title":"Configuration of Blocks","description":"","frontmatter":{},"headers":[{"level":2,"title":"MapSet","slug":"mapset"}],"relativePath":"concepts/block-types.md","lastUpdated":1636470238598}',p={},o=t(`__VP_STATIC_START__<h1 id="configuration-of-blocks" tabindex="-1">Configuration of Blocks <a class="header-anchor" href="#configuration-of-blocks" aria-hidden="true">#</a></h1><h2 id="mapset" tabindex="-1">MapSet <a class="header-anchor" href="#mapset" aria-hidden="true">#</a></h2><p>Example of configuration :</p><div class="language-json"><pre><code><span class="token punctuation">{</span>
...
</code></pre></div>__VP_STATIC_END__`,6),e=[o];function c(u,l,r,k,i,q){return a(),s("div",null,e)}var y=n(p,[["render",c]]);export{_ as __pageData,y as default};
