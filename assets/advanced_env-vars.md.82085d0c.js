import{_ as e,c as n,o as s,d as a}from"./app.a2baa444.js";const m='{"title":"Environment variables","description":"","frontmatter":{},"headers":[{"level":2,"title":"Web server","slug":"web-server"},{"level":2,"title":"Mail server","slug":"mail-server"},{"level":2,"title":"Sentry","slug":"sentry"},{"level":2,"title":"Security","slug":"security"},{"level":2,"title":"Storage keys","slug":"storage-keys"}],"relativePath":"advanced/env-vars.md","lastUpdated":1640970594810}',t={},o=a(`<h1 id="environment-variables" tabindex="-1">Environment variables <a class="header-anchor" href="#environment-variables" aria-hidden="true">#</a></h1><p>The backend use some environment variables for configuring some part of it.</p><p>Here is a summary.</p><h2 id="web-server" tabindex="-1">Web server <a class="header-anchor" href="#web-server" aria-hidden="true">#</a></h2><div class="language-yml"><pre><code><span class="token comment"># Port on which LocoKit will listen</span>
LCK_PORT=3030
