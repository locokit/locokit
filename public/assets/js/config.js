...
const LCK_SETTINGS = {
  ...
  PAGE_DATABASE_BACKGROUND_IMAGE_URL: '/img/locokit/logokit-grayscale.png',
  PAGE_404_BACKGROUND_IMAGE_URL: '/img/page-construction-vlogistique.png',
  LOGO_BG_WHITE_URL: '/img/locokit/logo.svg',
  LOGO_BG_PRIMARY_URL: '/img/locokit/logo-white.svg',
  LOGO_MOBILE_URL: '/img/locokit/logo-mobile.svg',
