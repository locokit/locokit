...
import { UserGroupQuery, UserGroupSchema } from './user-group-policy-variable.schema'
...
export const workspaceUserGroupPolicyVariableCreateResolver = resolve<UserGroupSchema, HookContext>(
  {
    async role(role) {
...
// Resolver for the basic data model (e.g. creating new entries)
export const workspaceUserGroupPolicyVariablePatchResolver = resolve<UserGroupSchema, HookContext>({
  async updatedAt() {
...
export const workspaceUserGroupPolicyVariableDispatchResolver: Resolver<
  UserGroupSchema,
  HookContext
> = resolve<UserGroupSchema, HookContext>({
  /**
...
export const workspaceUserGroupPolicyVariableQueryResolver = resolve<UserGroupQuery, HookContext>(
  {},
)
