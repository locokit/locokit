  ...
  await knex('table_row').insert([
    {
      ...
      data: JSON.stringify({
        [TABLES.PERSON.COLUMNS.FIRST_NAME]: 'Test',
        [TABLES.PERSON.COLUMNS.LAST_NAME]: 'Test',
  ...
  await knex('table_row').insert([
    {
      ...
      data: JSON.stringify({
        ...
        [TABLES.PROVIDER.COLUMNS.GEOZONE]: '75 93 94 92 78 60 22 29 35 56 44 49 53 72 85 79 86 17 16 18 28 16 17 45 41 14 61 50 27 76 95 77 91',
      ...
      data: JSON.stringify({
        ...
        [TABLES.PROVIDER.COLUMNS.GEOZONE]: '62 59 80 02 08 10 52 89 58 21 71 70 25 39 90 68 67 54 55 57 88 51',
        [TABLES.PROVIDER.COLUMNS.USER]: {
      ...
      data: JSON.stringify({
        ...
        [TABLES.PROVIDER.COLUMNS.GEOZONE]: '33 24 47 40 64 19 87 23 03 15 43 63 09 12 31 32 46 65 81 82 48 11 30 34 66 01 07 26 38 49 69 73 74 84 13 83 06 04 05 42',
        [TABLES.PROVIDER.COLUMNS.USER]: {
