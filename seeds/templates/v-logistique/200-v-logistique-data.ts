...
export async function seed(knex: Knex): Promise<any> {
  ...
  await knex("table_row").insert([{
    ...
    data: JSON.stringify({
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.FIRSTNAME]: "Prénom A",
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.LASTNAME]: "Bénéficiaire A",
    ...
    table_id: TABLES.VLO.LIST_RECIPIENT.ID,
    data: JSON.stringify({
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.FIRSTNAME]: "Prénom B",
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.LASTNAME]: "Bénéficiaire B",
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.USER]: {
        reference: 6,
    ...
    table_id: TABLES.VLO.LIST_RECIPIENT.ID,
    data: JSON.stringify({
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.FIRSTNAME]: "Hervé",
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.LASTNAME]: "LECOQ",
      [TABLES.VLO.LIST_RECIPIENT.COLUMNS.USER]: null
    })
  }])
