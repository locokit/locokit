...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c0 = peg$otherExpectation("function");
  const peg$c1 = /^[A-Z]/;
  ...
  const peg$c14 = function(first: any, arg: any): any { return arg };
  ...
  const peg$c41 = function(currentInteger: any): any {
        return {
          type: columnsTypes.NUMBER,
          value: currentInteger,
        }
      };
  const peg$c42 = peg$otherExpectation("decimal");
  const peg$c43 = function(currentDecimal: any): any {
        return {
